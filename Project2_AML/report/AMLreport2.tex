...
Possibly the simplest classifier we could have chosen, but nevertheless a powerful one. Aside from feature selection methods described above, it uses standarized data because of L2 standarization used inside it.
...
\textcolor{red}{something about how we use gridsearch, random search, cross-validation and such}

\section{Results}

\textcolor{red}{make sure to describe the pipeline for result reproduction}
